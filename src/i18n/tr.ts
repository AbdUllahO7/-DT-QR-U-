...
export const tr = {
  ...
  menu: {
      ...
      cancel_reason_prompt_title:"Iptal Nedeni",
      reason:"Sebep Yzama Kutusu",
      submit : "Gönder",
      confirm:"Gönder",
      confirm_cancel_title:"Yazdığınız sebep resturant trafına ulaşacaktır ",
      cancel_order_confirm :"Siparişi iptal edeceğinizinden emin misiniz ?",
      order_cancelled_success:"Siparişiniz Başarıyla Iptal edilidi",
      cancel:"red etmek",
      success:"Başarılı",
