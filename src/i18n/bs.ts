...
export const bs = {
    ...
    features: {
        ...
        list: {
            ...
            tableOrders: {
                title: 'Primajte Narudžbe sa Stolova',
                description: 'Kupci mogu naručiti direktno sa svojih stolova. Pojednostavite proces narudžbe i smanjite vrijeme čekanja.'
            },
            multiBranch: {
                title: 'Upravljanje Više Filijala',
                description: 'Upravljajte više filijala sa jednog mjesta. Kreirajte zasebne menije i cijene za svaku lokaciju.'
            },
            userRoles: {
                title: 'Upravljanje Korisnicima i Ulogama',
                description: 'Dodajte i upravljajte korisnicima sa različitim ulogama i dozvolama. Kontrolišite nivoe pristupa za svoj tim.'
            },
            productCustomization: {
                title: 'Prilagođavanje Proizvoda',
                description: 'Prilagodite proizvode sa sastojcima, alergenima, dodacima, kombo ponudama i više. Dajte kupcima potpunu kontrolu nad njihovim narudžbama.'
            }
        },
        cta: {
    ...
    pricing: {
        ...
        plans: {
            starter: {
                ...
                features: {
                    '0': '1 Restoran',
                    '1': 'Neograničeno Filijala',
                    '2': 'Neograničeno Korisnika',
                    '3': 'Neograničeno Proizvoda (Sastojci, Alergeni, Dodaci)',
                    '4': 'Upravljanje Zalihama',
                    '5': 'Radno Vrijeme/Smjene',
                    '6': 'Narudžbe za Stolove',
                    '7': 'Narudžbe za Preuzimanje',
                    '8': 'Narudžbe za Dostavu',
                    '9': 'Osnovna Analitika',
                    '10': 'Generator QR Koda',
                    '11': 'Mobilna Optimizacija',
                    '12': 'Višejezična Podrška',
                    '13': 'Opcionalne WhatsApp Narudžbe'
                },
                button: 'Započnite'
            },
            pro: {
                name: 'Pro',
                features: {
                    '0': 'Sve iz Početnog Plana',
                    '1': 'POS Integracija',
                    '2': 'Program Lojalnosti',
                    '3': 'Ponude i Promocije',
                    '4': 'Upravljanje Kupcima',
                    '5': 'Online Plaćanje',
                    '6': 'Sistem Rezervacija',
                    '7': 'Narudžbe iz Automobila',
                    '8': 'Automatska Sigurnosna Kopija',
                    '9': 'Napredna Analitika',
                    '10': 'Podrška 24/7',
                    '11': 'Izvještaji'
                },
                button: 'Uskoro'
            ...
            proPlus: {
                ...
                features: {
                    ...
                    '3': 'Privatna Domena',
                    '4': 'API Pristup',
                    '5': 'Preduzeće Analitika',
                    '6': 'Posvećen Menadžer Naloga',
    ...
    contact: {
        ...
        form: {
            ...
            error: 'Slanje poruke nije uspjelo. Molimo pokušajte ponovo ili nas kontaktirajte direktno na info@idigitek.com'
        }
    },
