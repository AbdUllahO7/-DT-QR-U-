  ...
  return (
    <div className={`flex flex-col items-center justify-center ${containerClasses[size]}`}>
      ...
      <div className="relative">
        ...
        >
          <div className="w-2 h-2 bg-gradient-to-r from-primary-500 to-primary-800 rounded-full"></div>
        </motion.div>
      </div>
      ...
      <div className="flex gap-1">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-2 h-2 bg-gradient-to-r from-primary-500 to-primary-800 rounded-full"
