  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        {/* Only show occupation toggle if the handler is provided (Branch Tables context) */}
        {onToggleOccupation && (
          <div className={`flex items-center justify-between`}>
            <button
        ...
        {/* Only show clear table button if the handler is provided (Branch Tables context) */}
        {onClearTable && (
