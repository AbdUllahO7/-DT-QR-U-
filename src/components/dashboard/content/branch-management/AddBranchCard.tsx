  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none">
        ...
        <div className="absolute top-20 right-20 w-1 h-1 bg-blue-500/40 rounded-full animate-pulse delay-300"></div>
        <div className="absolute bottom-20 left-20 w-1.5 h-1.5 bg-blue-600/35 rounded-full animate-ping delay-700"></div>
      </div>
      {/* Icon Container */}
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 text-center px-4">Yeni bir şube eklemek için tıklayın</p>
    </motion.button>
  );
};
