  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-0 sm:p-4 animate-in fade-in duration-200">
        <div
          className={`bg-white dark:bg-gray-800 rounded-none sm:rounded-2xl shadow-2xl w-full max-w-4xl h-full sm:h-auto sm:max-h-[85vh] overflow-hidden flex flex-col ${isRTL ? 'rtl' : 'ltr'
            }`}
          dir={isRTL ? 'rtl' : 'ltr'}
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 z-10 shrink-0">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <Layers className="h-5 w-5 sm:h-6 sm:w-6 text-primary-800" />
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 shadow-lg animate-in fade-in slide-in-from-bottom-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                          <input
                            ...
                            className="w-5 h-5 rounded dark:text-gray-300 border-gray-300 text-primary-800 focus:ring-primary-500"
                          />
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <label className="flex items-center gap-2 whitespace-nowrap cursor-pointer">
                                  <input
                                    ...
                                    className="w-4 h-4 text-primary-800 rounded focus:ring-primary-500"
                                  />
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end pt-4 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto flex justify-center items-center gap-2 px-5 py-2.5 text-sm font-medium text-white text-primary-800 hover:bg-primary-700 rounded-lg shadow-sm hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isSubmitting ? (
                          <>
                  ...
                  <div className="grid gap-4">
                    {productExtraCategories.map((category) => {
                      ...
                      return (
                        <div
                          key={category.id}
                          className={`bg-white dark:bg-gray-800 rounded-xl border transition-all duration-200 ${editingId === category.id
                              ...
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0 mb-6">
                                ...
                                <div className="flex items-center p-2 bg-gray-50 dark:bg-gray-700 rounded w-fit">
                                  <input
                                    ...
                                    className="rounded border-gray-300 dark:text-white text-primary-800 focus:ring-primary-500"
                                  />
