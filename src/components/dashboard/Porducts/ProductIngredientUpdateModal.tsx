...
const ProductIngredientUpdateModal: React.FC<ProductIngredientUpdateModalProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError('Malzemeler kaydedilirken bir hata oluştu');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-3xl mx-4 max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t('Malzemeleri Güncelle')}
            </h3>
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              {selectedIngredients.size} malzeme seçili
            </div>
          </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {filteredIngredients.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    {searchQuery ? t('Arama kriterlerine uygun malzeme bulunamadı') : t('Malzeme bulunamadı')}
                  </p>
                </div>
              ) : (
                      ...
                      >
                        ...
                        <div className="pr-8">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                            <span>Birim: {ingredient.unit}</span>
                            {ingredient.price && (
                              <span>Fiyat: {ingredient.price.toFixed(2)} ₺</span>
                            )}
                          </div>
        ...
        <div className="flex justify-between items-center p-6 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm text-gray-600 dark:text-gray-400">
            {selectedIngredients.size} malzeme seçildi
          </div>
