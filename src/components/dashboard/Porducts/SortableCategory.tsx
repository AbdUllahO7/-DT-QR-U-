    ...
    const SortableGridProductCard = ({
      ...
      return (
        <div
          ...
          className={`group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-1 ${isProductDragging
            ? 'shadow-2xl shadow-primary-500/25 ring-2 ring-primary-500 scale-105 z-50'
            : isNew
              ? 'border-2 border-primary-800 dark:border-primary-500 ring-4 ring-primary-200 dark:ring-primary-800 shadow-xl shadow-primary-500/30'
          ...
          <button
            {...productAttributes}
            {...productListeners}
            className="absolute top-3 left-3 z-20 p-2 bg-white/90 dark:bg-gray-800/90 text-gray-400 hover:text-primary-800 dark:hover:text-primary-800 rounded-lg cursor-grab active:cursor-grabbing transition-all duration-200 hover:scale-110 shadow-md backdrop-blur-sm"
          ...
          <div className="relative h-48 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
            ...
            <div className="absolute top-3 right-3 z-10">
              <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium backdrop-blur-md border transition-all duration-200 ${product.isAvailable
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
              ...
              {onOpenAddonsManagement && (
                <button
                  ...
                  className="p-3 text-primary-800 hover:bg-primary-700 text-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-200"
          ...
          <div className="p-4">
            <h4 className="font-semibold text-gray-900 dark:text-white mb-2 truncate text-lg group-hover:text-primary-800 dark:group-hover:text-primary-800 transition-colors">
              {product.name}
            </h4>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
              <span className="text-xl font-bold bg-gradient-to-r from-primary-600 to-primary-800 dark:from-primary-400 dark:to-primary-800 bg-clip-text text-transparent">
          ...
          <div className={`relative flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
            <div className={`flex items-center gap-3 md:gap-4 flex-1 ${isRTL ? 'flex-row-reverse' : ''}`}>
              ...
              <button
                {...attributes}
                {...listeners}
                className="p-2.5 text-gray-400 hover:text-primary-800 dark:hover:text-primary-800 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-xl cursor-grab active:cursor-grabbing transition-all duration-200 hover:scale-110"
                ...
                <div className={`flex flex-wrap items-center gap-2 md:gap-3 mb-1 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  ...
                  {isReorderingProducts && (
                    <div className="flex items-center gap-2 px-3 py-1 bg-primary-100 dark:bg-primary-900/30 rounded-full">
                      <Loader2 className="w-3.5 h-3.5 animate-spin text-primary-800 dark:text-primary-800" />
            ...
            <div className={`flex items-center gap-2 flex-shrink-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
              <div className={`flex items-center gap-0.5 md:gap-1 bg-gray-100 dark:bg-gray-700/50 rounded-xl p-0.5 md:p-1 ${isRTL ? 'flex-row-reverse' : ''}`}>
                <button
                  ...
                  className="p-1.5 md:p-2 text-gray-600 dark:text-gray-400 hover:text-primary-800 dark:hover:text-primary-800 hover:bg-white dark:hover:bg-gray-600 rounded-lg transition-all duration-200"
              ...
              {viewMode === 'list' && (
                <button
                  ...
                  className={`p-2 md:p-2.5 rounded-xl transition-all duration-200 ${category.isExpanded
                    ? 'text-primary-800 text-white shadow-lg shadow-primary-500/25'
